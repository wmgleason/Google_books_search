...
// Using React Hooks maintains state
// Applying the className, children and onClick props to the save button element
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Success - your book has been saved!</Modal.Title>
        </Modal.Header>
